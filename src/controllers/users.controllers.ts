...
export const oauthController = async (req: Request, res: Response) => {
  ...
  const urlRedirect = `${process.env.clientRedirectCallback}?access_token=${result.access_token}&refresh_token=${result.refresh_token}&new_user=${result.newUser}&verify=${result.verify}`
...
export const verifyEmailController = async (
  ...
  //Đã verify rồi thì mình sẽ không báo lỗi => trả về status OK với message verify trước đó rồi
